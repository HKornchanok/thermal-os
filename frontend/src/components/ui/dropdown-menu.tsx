...
// Standard shadcn dropdown-menu primitive (new-york variant), trimmed to
// the parts we actually use today: Root, Trigger, Content, Item, Label,
// Separator, Group. Sub-menus, checkbox/radio items, and shortcuts can
// be added later if a feature needs them.
