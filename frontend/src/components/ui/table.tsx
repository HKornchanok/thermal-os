...
// Standard shadcn Table primitive. Just styled wrappers around the
// native HTML table elements — no headless logic. We pair this with
// @tanstack/react-table on consumer pages for sorting/pagination/etc.
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "hover:bg-muted/50 border-b border-border transition-colors data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
